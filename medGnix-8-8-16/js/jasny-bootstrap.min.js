...
if ("undefined" == typeof jQuery) throw new Error("Jasny Bootstrap's JavaScript requires jQuery"); + function(a) {
    ...
    b.DEFAULTS = {
        ...
        if (!this.state) {
            ...
            if (this.$element.trigger(b), !b.isDefaultPrevented()) {
                ...
                var g = function() {
                    "slide-in" == this.state && (this.state = "slid", c.removeClass("canvas-sliding").addClass("canvas-slid"), $(".button").addClass("active"),this.$element.trigger("shown.bs.offcanvas"))
                };
        ...
        if ("slid" === this.state) {
            ...
            if (this.$element.trigger(b), !b.isDefaultPrevented()) {
                ...
                var c = a(".canvas-slid"),                   
                    ...
                    e = function() {
                        "slide-out" == this.state && (this.state = null, this.placement = null, this.$element.removeClass("in"),$(".button").removeClass("active"), c.removeClass("canvas-sliding"), c.add(this.$element).add("body").each(function() {
    ...
    }, a(document).on("mouseover.bs.offcanvas.data-api", "[data-toggle=offcanvas]", function(b) {
        var c, d = a(this),
